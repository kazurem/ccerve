...
* that it works with the strftime function. I did some research and testing and was unable 
* to make it work with std::string.
*/
...
const char* getCurrentTime() {
    time(&s_CurrentTime);
    std::strftime(s_CurrentTimeStr, s_CurrentTimeStrSize,
                  s_TimeFormatStr, std::localtime(&s_CurrentTime));
