...
/**
 * @file sinks.hpp
 * @brief Contains declarations for various sinks. Sinks are wrappers over
...
2. Make another class which inherit from base class but is not abstract. Name it
BaseSinkConstructible. Use this as the type for SinksVector.
*/
class BaseSink {
    public:
...
class FileSink : public BaseSink {
     ...
     * @param p_Path The path of the log file. If the path and file do not
